...
overflow-y-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end mb-6">
                <div>
                    ...
                    <label for="new-re" class="block text-sm font-medium 
                        text-gray-700">Novo
...
font-medium text-gray-700">Data:</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="edit-re" name="edit-res[]"
...
py-2 bg-gray-50 border border-gray-300 rounded-lg">
    ...
    <script type="module">
        ...
        // === CONFIGURAÇÃO DE USUÁRIOS ===
            ...
            { username: 'keimilly', password: 'keimilly121' },
            { username: 'maicon', password: 'maicon123' },
            { username: 'ector', password: 'ector123' },
            { username: 'carlostucci', password: 'carlost123' },
            { username: 'celso', password: 'celso123' },
            { username: 'charlesdaniel', password: 'charlesd123' },
            { username: 'edvaldo', password: 'edvaldo123' },          
            { username: 'fabricio', password: 'fabricio123' }, 
            { username: 'fernando', password: 'fernando123' }, 
            { username: 'joaovitor', password: 'joaov123' }, 
            { username: 'lilian', password: 'lilian123' }, 
            { username: 'luilton', password: 'luilton123' }, 
            { username: 'marcio', password: 'marcio123' }, 
            { username: 'matheus', password: 'matheus123' }, 
            { username: 'rodrigo', password: 'rodrigo123' }, 
            { username: 'tiago', password: 'tiago123' }, 
            { username: 'vandersonjesus', password: 'vanderson123' }, 
            { username: 'denilsonoliveira', password: 'denilson123' }, 
            { username: 'eduardo', password: 'eduardo123' }, 
            { username: 'beatriz', password: 'beatriz123' }, 
            { username: 'julianageraldo', password: 'juliana123' }, 
            { username: 'josecarlos', password: 'josecarlos123' }, 
            { username: 'maicon2', password: 'maicon25' }, 
            { username: 'mailsoncarvalho', password: 'mailson123' }, 
            { username: 'aloisiobranco', password: 'aloisio123' }, 
            { username: 'gabrielmt', password: 'gabriel123' }, 
            { username: 'renato', password: 'renato123' }
        ];
        const motoristaUsers = {
            ...
            'admin': { nome: 'Admin Rafael', is_admin: true, is_motorista_fixo: false, userId: 'admin-Rafael-id' },
            'keimilly': { nome: 'Admin Keimilly', is_admin: true, is_motorista_fixo: false, userId: 'admin-Keimilly-id' },
            'maicon': { nome: 'Maicon', is_admin: false, is_motorista_fixo: true, userId: 'motorista-maicon-id' },
            'ector': { nome: 'Ector', is_admin: false, is_motorista_fixo: true, userId: 'motorista-Ector-id' },
            'carlostucci': { nome: 'Carlos Tucci', is_admin: false, is_motorista_fixo: true, userId: 'motorista-carlostucci-id' },
            'celso': { nome: 'Celso', is_admin: false, is_motorista_fixo: true, userId: 'motorista-celso-id' },
            'charlesdaniel': { nome: 'Charles Daniel', is_admin: false, is_motorista_fixo: true, userId: 'motorista-charlesdaniel-id' },
            'edvaldo': { nome: 'Edvaldo', is_admin: false, is_motorista_fixo: true, userId: 'motorista-edvaldo-id' },
            'fabricio': { nome: 'Fabricio', is_admin: false, is_motorista_fixo: true, userId: 'motorista-fabricio-id' },
            'fernando': { nome: 'Fernando', is_admin: false, is_motorista_fixo: true, userId: 'motorista-fernando-id' },
            'joaovitor': { nome: 'João Vitor', is_admin: false, is_motorista_fixo: true, userId: 'motorista-joaovitor-id' },
            'lilian': { nome: 'Lilian', is_admin: false, is_motorista_fixo: true, userId: 'motorista-lilian-id' },
            'luilton': { nome: 'Luilton', is_admin: false, is_motorista_fixo: true, userId: 'motorista-luilton-id' },
            'marcio': { nome: 'Marcio', is_admin: false, is_motorista_fixo: true, userId: 'motorista-marcio-id' },
            'matheus': { nome: 'Matheus', is_admin: false, is_motorista_fixo: true, userId: 'motorista-matheus-id' },
            'rodrigo': { nome: 'Rodrigo', is_admin: false, is_motorista_fixo: true, userId: 'motorista-rodrigo-id' },
            'tiago': { nome: 'Tiago', is_admin: false, is_motorista_fixo: true, userId: 'motorista-tiago-id' },
            'vandersonjesus': { nome: 'Vanderson Jesus', is_admin: false, is_motorista_fixo: true, userId: 'motorista-vandersonjesus-id' },
            'denilsonoliveira': { nome: 'Denilson Oliveira', is_admin: false, is_motorista_fixo: true, userId: 'motorista-denilsonoliveira-id' },
            'eduardo': { nome: 'Eduardo', is_admin: false, is_motorista_fixo: true, userId: 'motorista-eduardo-id' },
            'beatriz': { nome: 'Beatriz', is_admin: false, is_motorista_fixo: true, userId: 'motorista-beatriz-id' },
            'julianageraldo': { nome: 'Juliana Geraldo', is_admin: false, is_motorista_fixo: true, userId: 'motorista-julianageraldo-id' },
            'josecarlos': { nome: 'José Carlos', is_admin: false, is_motorista_fixo: true, userId: 'motorista-josecarlos-id' },
            'maicon2': { nome: 'Maicon (2)', is_admin: false, is_motorista_fixo: true, userId: 'motorista-maicon2-id' },
            'mailsoncarvalho': { nome: 'Mailson Carvalho', is_admin: false, is_motorista_fixo: true, userId: 'motorista-mailsoncarvalho-id' },
            'aloisiobranco': { nome: 'Aloisio Branco', is_admin: false, is_motorista_fixo: true, userId: 'motorista-aloisiobranco-id' },
            'gabrielmt': { nome: 'Gabriel MT', is_admin: false, is_motorista_fixo: true, userId: 'motorista-gabrielmt-id' },
            'renato': { nome: 'Renato', is_admin: false, is_motorista_fixo: true, userId: 'motorista-renato-id' },
        };
        ...
        window.onload = () => {
            // ---> INÍCIO DA MODIFICAÇÃO PARA LOGIN PERSISTENTE E CORREÇÃO DA TELA CINZA
            const loggedInUser = localStorage.getItem('loggedInUser');
            if (loggedInUser && users.find(u => u.username === loggedInUser)) {
                loginPage.classList.add('hidden');
                appPage.classList.remove('hidden');
                setMotoristaReadOnly(loggedInUser);
            } else {
        ...
        loginForm.addEventListener('submit', function (event) {
            ...
            if (foundUser) {
                ...
                localStorage.setItem('loggedInUser', username); // Salva o usuário no localStorage
                // ---> FIM DA MODIFICAÇÃO
            ...
            if (deleteButton) {
                ...
                if (confirm('Tem certeza que deseja excluir este lançamento? Esta ação não pode ser desfeita.')) {
                    try {
                        ...
                        renderLancamentosList(); // Re-render the list
                    } catch (error) {
        ...
        function addEditPassageiroRow(re =
            '', nome = '') {
        ...
        document.getElementById('edit-lancamento-form').addEventListener('submit', async function (event) {
            ...
            const passageirosExtras = resExtras.map((re, i) => ({
                re: re,
                nome: nomesExtras[i]
            })).filter(p => p.re && p.nome);
        ...
        function populateTransportadosDatalist() {
            const reDatalist = document.querySelector('#transportados-re-list') ||
        ...
        document.getElementById('add-transportado').addEventListener('click', async () => {
            ...
            if (newRE && newNome) {
                const existing = transportadosData.find(item => item.re === newRE ||
